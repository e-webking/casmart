	...
	<div class="common-summary-service row">
		<div class="item delivery <?= ( isset( $errors['service']['delivery'] ) ? 'error' : '' ); ?> col-sm-6">
			<div class="header">
				...
				<h3><?= $enc->html( 'Lieferung und Montage für Neumöbel sind im Preis inklusive. Für Möbel im Abverkauf/SALE ab Ausstellung berechnen wir unsere Selbstkosten.', $enc::TRUST ); ?></h3>
			</div>
