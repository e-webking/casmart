...
namespace In2code\Shopsite\Utility;

use In2code\Shopsite\Domain\Model\Form;
use In2code\Shopsite\Domain\Model\Mail;
use In2code\Shopsite\Domain\Repository\MailRepository;
use In2code\Shopsite\Domain\Validator\SpamShield\SessionMethod;
...
class SessionUtility extends AbstractUtility
{
    ...
    /**
     * Set a shopsite session and merge to old one
     *
     * @param string $name session name
