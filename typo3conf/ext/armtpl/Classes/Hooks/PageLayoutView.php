            ...
            case '2':
                ...
                if (!empty($row['pi_flexform'])) {
                    ...
                    if(!empty($flexArr['field_imagelarge'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imagelarge'].'" style="height:40px" height="40" alt="Large version" /> (Large Desktop)';
                    }
                    if(!empty($flexArr['field_imagemid'])) {
                        $itemContent .= '&nbsp;&nbsp;&nbsp;&nbsp;<img src="/uploads/tx_armtpl/'.$flexArr['field_imagemid'].'" style="height:40px" height="40" alt="Desktop version" /> (Desktop)';
                    }
                    if(!empty($flexArr['field_imagetab'])) {
                        $itemContent .= '&nbsp;&nbsp;&nbsp;&nbsp;<img src="/uploads/tx_armtpl/'.$flexArr['field_imagetab'].'" style="height:40px" height="40" alt="Tablet version" /> (Tablet)';
                    }
                    if(!empty($flexArr['field_imagemob'])) {
                        $itemContent .= '&nbsp;&nbsp;&nbsp;&nbsp;<img src="/uploads/tx_armtpl/'.$flexArr['field_imagemob'].'" style="height:40px" height="40" alt="mobile version" /> (Mobile)';
                    }
                }
                break;
            case '6':
            ...
            case '7':
                ...
                if (!empty($row['pi_flexform'])) {
                    ...
                    if(!empty($flexArr['field_img'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_img'].'" style="height:40px" height="40" alt="Image" />';
                    }
                }
                break;
             case '9':
            ...
            case '13':
                ...
                if (!empty($row['pi_flexform'])) {
                    ...
                    if(!empty($flexArr['field_imageone'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imageone'].'" style="height:40px" height="40" alt="Image" />';
                    }
                    ...
                    if(!empty($flexArr['field_imagetwo'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imagetwo'].'" style="height:40px" height="40" alt="Image" />';
                    }
                    ...
                    if(!empty($flexArr['field_imagethree'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imagethree'].'" style="height:40px" height="40" alt="Image" />';
                    }
                    ...
                    if(!empty($flexArr['field_imagefour'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imagefour'].'" style="height:40px" height="40" alt="Image" />';
                    }
                    ...
                    if(!empty($flexArr['field_imagefive'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_imagefive'].'" style="height:40px" height="40" alt="Image" />';
                    }
            ...
            case '15':
                ...
                if (!empty($row['pi_flexform'])) {
                    ...
                    if(!empty($flexArr['field_image'])) {
                        $itemContent .= '<br /><img src="/uploads/tx_armtpl/'.$flexArr['field_image'].'" style="height:40px" height="40" alt="Image" /> (Default)';
                    }
                    if(!empty($flexArr['field_hover'])) {
                        $itemContent .= '&nbsp;&nbsp;&nbsp;&nbsp;<img src="/uploads/tx_armtpl/'.$flexArr['field_hover'].'" style="height:40px" height="40" alt="Hover" /> (Hover)';
                    }
                }
                break;
            case '16':
