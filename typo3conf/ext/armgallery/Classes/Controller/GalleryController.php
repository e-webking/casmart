...
//        $jsFile = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath('armgallery') . 'Resources/Public/js/jquery-1.11.1.min.js';
//        $this->pageRenderer->addJsLibrary('galjquery', $jsFile, $type= 'text/javascript', $compress=TRUE, $forceOnTop=FALSE);
