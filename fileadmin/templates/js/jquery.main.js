...
// cusom slideshow init
function initCustomGallery() {
	var bigGalleryClass = 'big-type';
	jQuery('.slideshow').each(function() {
		var gallery = jQuery(this);
		
		if (gallery.hasClass(bigGalleryClass)) {
...
function initCarousel() {
	jQuery('.gallery, .slideshow, .slideshow2').scrollGallery({
		mask: '.mask',
		slider: '.slideset',
		slides: '.slide',
		btnPrev: 'a.btn-prev',
...
function initSlideShow() {
	jQuery('.slideshow-autorotate, .slideshow2, .gallery').fadeGallery({
		slides: 'div.slide',
		btnPrev: 'a.btn-prev',
		btnNext: 'a.btn-next',
 ...
 */
;(function($){
    $('.icon-mouse-event').children('a').hover(function(){
        var orisrc = $(this).children('img').attr('src');
        var hovsrc = $(this).children('img').attr('title');
        if (hovsrc.indexOf('.') > 0) {
            $(this).children('img').attr('src', function (i, src) {
                return src.replace(orisrc, hovsrc);
            });
            $(this).children('img').attr('title', function (i, src) {
                return src.replace(hovsrc, orisrc);
            });
        }
    }, function() {
        var orisrc = $(this).children('img').attr('src');
        var hovsrc = $(this).children('img').attr('title');
        if (orisrc.indexOf('.') > 0 && hovsrc.indexOf('.') > 0) {
            $(this).children('img').attr('src', function (i, src) {
                return src.replace(orisrc, hovsrc);
            });
            $(this).children('img').attr('title', function (i, src) {
